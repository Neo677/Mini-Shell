...
//         ft_export(&exec->env_cpy, cmd->arg[1]);
...
// {
//     printf("test\n");
//     if (ft_strcmp2(cmd->arg[0], "env") == 0 || ft_strcmp2(cmd->arg[0], "pwd") == 0 ||
//     ft_strcmp2(cmd->arg[0], "export") == 0 || ft_strcmp2(cmd->arg[0], "unset") == 0 ||
//     ft_strcmp2(cmd->arg[0], "echo") == 0 || ft_strcmp2(cmd->arg[0], "exit") == 0 ||
//     ft_strcmp2(cmd->arg[0], "cd") == 0)
//     {
//         return (1);
//     }
//     return (0);
